...
class CustomBottomBarState extends State<CustomBottomBar> {
  ...
  List<BottomMenuModel> bottomMenuList = [
    ...
    BottomMenuModel(
      icon: ImageConstant.imgNavKhAHC,
      activeIcon: ImageConstant.imgNavKhAHC,
      title: "lbl_kh_a_h_c".tr,
      type: BottomBarEnum.Khahc,
    ),
    BottomMenuModel(
      icon: ImageConstant.imgNavTIKhoN,
      activeIcon: ImageConstant.imgNavTIKhoN,
      title: "lbl_t_i_kho_n".tr,
      type: BottomBarEnum.Tikhon,
    ),
    BottomMenuModel(
      icon: ImageConstant.imgNavThNgBO,
      activeIcon: ImageConstant.imgNavThNgBO,
      title: "lbl_th_ng_b_o".tr,
