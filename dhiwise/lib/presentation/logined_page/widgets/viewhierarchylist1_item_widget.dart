  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          CustomImageView(
            imagePath: viewhierarchylist1ItemModelObj?.imageClass,
            height: 48.adaptSize,
            width: 48.adaptSize,
          ),
          ...
          SizedBox(
            width: 145.h,
            child: Text(
              viewhierarchylist1ItemModelObj.text!,
              maxLines: 2,
          ...
          Row(
            ...
            children: [
              Text(
                viewhierarchylist1ItemModelObj.text1!,
                style: CustomTextStyles.bodyMediumGray700,
              ),
              Padding(
                padding: EdgeInsets.only(left: 54.h),
                child: Text(
                  viewhierarchylist1ItemModelObj.text2!,
          ...
          Row(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  viewhierarchylist1ItemModelObj.text3!,
                  style: CustomTextStyles.bodyMediumGray700,
                ),
              ),
              Padding(
